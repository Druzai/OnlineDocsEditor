...
import ru.app.models.*;
import ru.app.repositories.DocumentRepository;
import ru.app.repositories.DocumentUserRightsRepository;
import ru.app.repositories.ParagraphRepository;
...
public class DocumentService {
    ...
    public void editDocument(WSMessage wsMessage) {
        ...
        var parList = wsMessage.getContent().stream()
                .map(item -> new Paragraph(item.getNumber(), item.getData(), item.getAlign())).collect(Collectors.toList());
